...
//         switch (block.type) {
//             case 'header':
//                 return (<Title level={block.data.level}><span dangerouslySetInnerHTML={{ __html: text }} /></Title>)
//             case 'paragraph':
//                 return (<Paragraph><span dangerouslySetInnerHTML={{ __html: text }} /></Paragraph>)
//             case 'imageUrl':
//                 return (<img src={block.data.url} title={block.data.caption} alt={block.data.caption} style={{ maxWidth: '100%', height: 'auto' }} />)
//             case 'image':
//                 return (<img src={block.data.file.url} title={block.data.caption} alt={block.data.caption} style={{ maxWidth: '100%', height: 'auto' }} />)
//             case 'code':
//                 const codeHtml = "<pre><code class=\"hljs \">" + hljs.highlightAuto(block.data.code).value + "</code></pre>";
//                 return (<Paragraph code={false}><div dangerouslySetInnerHTML={{ __html: codeHtml }} /></Paragraph>)
//             case 'list':
//                 let listJSX;
...
//                 }
//                 return (<Paragraph >{listJSX}</Paragraph>)
//             case 'embed':
//                 return (
//                     <>
...
//                 )
//             case 'table':
//                 if (block.data.content.length === 0) return (<></>)
