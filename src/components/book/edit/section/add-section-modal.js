...
class AddSectionModalComponent extends React.Component {
    state = { loading: false, };
...
const AddSectionModal = connect(mapStateToProps, mapDispatchToProps)(AddSectionModalComponent);
export default withApollo(AddSectionModal)
