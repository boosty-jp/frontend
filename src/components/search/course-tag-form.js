...
class CourseTagSelectComponent extends React.Component {
    constructor(props) {
        super(props);
...
const CourseTagSelect = connect(mapStateToProps, mapDispatchToProps)(CourseTagSelectComponent)
export default CourseTagSelect