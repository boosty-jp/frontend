...
const TermsPage = () => {
    return (
        <TermLayout activePage="term">
            <SEO title="利用規約" description="boostyをご利用いただく上での規約についてご案内します。" />
            <Typography>
                <Title level={1} style={{ marginBottom: '30px', textAlign: 'center' }}>利用規約</Title>
                <div>
                    <Paragraph>
                        この利用規約（以下「本規約」といいます。）は、「boosty」等、株式会社wever（以下「当社」といいます。）が提供する全てのサービス（以下「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下「ユーザー」といいます。）が本サービスをご利用の際は、本規約にご同意されたものとみなします。
                    </Paragraph>
                </div>
                <Divider />
                ...
                <div>
                    ...
                    <Paragraph>
                        2. ユーザーが本サービスを利用して投稿ないしアップロードした投稿内容の著作権については、当該ユーザーその他既存の権利者に留保されるものとします。
                    </Paragraph>
                    <Paragraph>
                ...
                <div>
                    ...
                    <Paragraph>⑧ ユーザーが本サービス上に不適切な内容を投稿したと当社が判断した場合。</Paragraph>
